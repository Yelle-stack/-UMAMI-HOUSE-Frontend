    ...
    <div className='bg3 flex flex-col gap-12 px-16 py-16'>
      <div className='grid place-content-center gap-6 text-center'>
        ...
        <div className='flex items-center justify-center max-w-xl mx-auto w-full'>
          <input type="email" placeholder='Enter email address' className='grow px-4 py-3 border-2 border-r-0 border-amber-300 rounded-l-full outline-none text-sm'/>
          <button className='bg-amber-300 text-white px-6 py-3 rounded-r-full font-bold'>Join Now</button>
        </div>
      </div>
      <div className='flex flex-col md:flex-row justify-between items-center md:text-left gap-6'>
        <div>
          <h2 className='text-2xl font-bold'>UMAMI HOUSE</h2>
          <div className='flex justify-between md:justify-start gap-4 mt-3 text-amber-200'>
      ...
      <p className='text-center text-sm mt-4'>©️ 2026 YUMI'S DINER. All rights reserved.</p>
    </div>
  )
}
