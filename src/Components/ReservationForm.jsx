    ...
    <div className='min-h-screen bg p-6 md:p-12'>
      <div className='max-w-6xl mx-auto grid md:grid-cols-3'>
        <form className='md:col-span-2 bg2 p-8 shadow-md'>
          <h2 className='text-xl font-semibold text-amber-300 uppercase tracking-wider'>Online Reservation</h2>
          <h1 className='text-3xl font-bold mb-4'>Dine With Us- <span className='text-amber-300'>Reserve Now</span> </h1>
          <div className='grid md:grid-cols-2 gap-4'>
            ...
            <button type="submit" className='w-full p-3 mt-4 bg-amber-300 text-white hover:bg-amber-600 transition font-bold cursor-pointer'>Book A Table</button>
        </form>
